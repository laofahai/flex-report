      ...
      <div>
        ...
        <div className="grid gap-4">
          ...
          {designs.map((design) => (
            <Card
              key={design.id}
              className="relative group border border-gray-200 hover:shadow-lg transition"
            >
              <div className="absolute right-4 top-4 flex gap-2 opacity-0 group-hover:opacity-100 transition">
                ...
                <Button size="sm" variant="destructive" onClick={() => setDeleteId(design.id!)}>
                  删除
                </Button>
              </div>
